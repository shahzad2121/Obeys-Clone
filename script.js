...
tl.from('#line1-counter',{
    opacity:0,
    onStart:function(){
        var h5timer = document.querySelector('#line1-counter h5');
        var grow = 0;
...
tl.from('#hero-text h1, #hero-text h2, #hero-text h3',{
    y:120,
    stagger:0.1,
})
}
...
function flagAnimation(){
    document.addEventListener("mousemove", function (dets) {
      ...
      document.querySelector(".hero-text3").addEventListener("mouseenter", function () {
        gsap.to("#flag", {
          opacity: 1
        })
      })
      document.querySelector(".hero-text3").addEventListener("mouseleave", function () {
        gsap.to("#flag", {
          opacity: 0
        })
      })
